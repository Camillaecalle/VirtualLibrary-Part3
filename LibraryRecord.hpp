...
//Date: March 4, 2023
//LibraryRecord.hpp
//This file is a subclass of ArrayBag and declares functions for our Library Record that will be implemented in our
//.cpp file.
...
*/
    int getCheckOutHistory(const Book& checked_out) const;
    /**
...
/**
  ...
  However, [book1, book2, book2, book3] is not equivalent to [book1, book2, book3, book3], because it contains two copies of book2 and only one copy of book3*/
    bool equivalentRecords(const LibraryRecord& another_library_record);
    /**
...
*/
    void operator+= (const LibraryRecord& object);
    /** @param:   A reference to another LibraryRecord object
